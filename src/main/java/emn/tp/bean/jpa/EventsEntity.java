...
public class EventsEntity implements Serializable {
    ...
    @OneToMany(mappedBy="events", targetEntity=ParticipateEntity.class)
    private List<ParticipateEntity> listOfParticipate;
    ...
    public void setListOfParticipate( List<ParticipateEntity> listOfParticipate ) {
        this.listOfParticipate = listOfParticipate;
    }
    public List<ParticipateEntity> getListOfParticipate() {
        return this.listOfParticipate;
    }

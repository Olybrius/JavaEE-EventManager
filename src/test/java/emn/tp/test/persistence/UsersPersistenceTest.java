/*
 * Created on 20 oct. 2014 ( Time 21:44:45 )
...
public class UsersPersistenceTest 
{
	...
	private void process(UsersPersistence service, UsersEntityMock mock, String mail ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		UsersEntity entity = service.load( mail );
		if ( entity != null ) {
			// Found 

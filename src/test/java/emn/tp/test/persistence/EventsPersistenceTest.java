...
public class EventsPersistenceTest 
{
	...
	private void process(EventsPersistence service, EventsEntityMock mock, String url ) {
		System.out.println("----- "  );
		System.out.println(" . load : " );
		EventsEntity entity = service.load( url );
		if ( entity != null ) {
			// Found 
			...
			entity = mock.createInstance( url ) ;
			...
			boolean deleted = service.delete( url );
